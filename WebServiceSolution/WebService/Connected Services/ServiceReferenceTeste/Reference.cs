...
namespace WebService.ServiceReferenceTeste {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReferenceTeste.IServiceBloodCrowd")]
    public interface IServiceBloodCrowd {
        ...
        WebService.ServiceReferenceTeste.Donor[] GetDonors();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceBloodCrowd/GetDonors", ReplyAction="http://tempuri.org/IServiceBloodCrowd/GetDonorsResponse")]
        System.Threading.Tasks.Task<WebService.ServiceReferenceTeste.Donor[]> GetDonorsAsync();
        ...
        WebService.ServiceReferenceTeste.Donor[] searchByName(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceBloodCrowd/searchByName", ReplyAction="http://tempuri.org/IServiceBloodCrowd/searchByNameResponse")]
        System.Threading.Tasks.Task<WebService.ServiceReferenceTeste.Donor[]> searchByNameAsync(string name);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceBloodCrowdChannel : WebService.ServiceReferenceTeste.IServiceBloodCrowd, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceBloodCrowdClient : System.ServiceModel.ClientBase<WebService.ServiceReferenceTeste.IServiceBloodCrowd>, WebService.ServiceReferenceTeste.IServiceBloodCrowd {
        ...
        public WebService.ServiceReferenceTeste.Donor[] GetDonors() {
            return base.Channel.GetDonors();
        }
        
        public System.Threading.Tasks.Task<WebService.ServiceReferenceTeste.Donor[]> GetDonorsAsync() {
            return base.Channel.GetDonorsAsync();
        }
        
        public WebService.ServiceReferenceTeste.Donor[] searchByName(string name) {
            return base.Channel.searchByName(name);
        }
        
        public System.Threading.Tasks.Task<WebService.ServiceReferenceTeste.Donor[]> searchByNameAsync(string name) {
